...
export class UserCompanyTable1652905996836 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`users_companies\` (\`id\` int NOT NULL AUTO_INCREMENT, \`user_id\` int NOT NULL, \`company_id\` int NOT NULL, UNIQUE INDEX \`REL_ac4c935c0d2e9cbf0b6fe41d25\` (\`user_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
